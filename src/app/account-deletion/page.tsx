    ...
    <main className="mx-auto max-w-3xl px-4 py-16">
      ...
      <div className="mt-10 space-y-10">
        ...
        <section>
          ...
          <p className="text-slate-700">
            Users may delete Emergency contacts (can add or remove up to 5 contacts) at any time within the app. 
            Other data (such as account information and activity data) is deleted only when the account is deleted.
          </p>
        </section>
